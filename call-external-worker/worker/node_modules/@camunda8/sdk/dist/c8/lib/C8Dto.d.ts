...
export interface SearchProcessInstanceRequest {
    ...
    /** Sort field criteria. */
    sort: Array<{
        field: 'processInstanceKey' | 'processDefinitionId' | 'processDefinitionName' | 'processDefinitionVersion' | 'processDefinitionVersionTag' | 'processDefinitionKey' | 'parentProcessInstanceKey' | 'parentFlowNodeInstanceKey' | 'state' | 'startDate' | 'endDate' | 'tenantId' | 'hasIncident';
        /** The order in which to sort the related field. Default value: ASC */
        order?: 'ASC' | 'DESC';
    }>;
