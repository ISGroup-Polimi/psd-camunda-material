            ...
            if (listMethods[key]) {
                ...
                this[`${methodName}Stream`] = async (data) => {
                    ...
                    stream.on('error', (error) => {
                        ...
                        supportLogger.log(`${methodName}Stream error emitted by stream - ${error.code} - ${error.message} - ${error.details}`);
                        this.emit(exports.MiddlewareSignals.Event.Error);
